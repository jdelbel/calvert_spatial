...
#Looking at relationship between Chl and TCHLA
...
chl_lm = lm(bulk_chl~tchla, data = chem_compare) #Create the linear regression
summary(chl_lm) #Review the results
...
#Microscopy May - October 2018-2019 time-series - Calvert
...
```{r}
#Tried adding chlorophyll to the area plot - too complex, not going to work.
```
