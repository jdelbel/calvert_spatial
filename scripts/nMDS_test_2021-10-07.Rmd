...
#Also check out https://stackoverflow.com/questions/21474388/colorize-clusters-in-dendogram-with-ggplot2

#determine number of clusters (need to find ways to full determine this)
cut <- 4

#Find clusters
clust <- cutree(dend_micro, k = cut)

clust_df <- data.frame(label = names(clust), cluster = clust)
