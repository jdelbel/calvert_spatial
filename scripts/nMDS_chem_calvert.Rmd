...
```{r}
c_long_bar %>%   
  ggplot(aes(x = phyto_group, y = sample_name, fill = log10(TChla_mean + 1))) +
...
ggsave(here("figures_rev2", "heat_chemtax.png"),
...
ggsave(here("figures_rev2", "bar_chemtax_cluster_2.png"),
       width = 16, height = 18, dpi = 300)
