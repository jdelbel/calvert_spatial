...
#Remove rows with NaNs - should select the ones I am using here before I delete NAs.
mm_no_chl <- mm_no_chl %>% 
  drop_na()

#Separating into response variables (microscopy counts) and Explainatory variables (Environmental)
resp <- mm_no_chl[, 22:1]
...
ggsave(here("figures_rev2", "rda_calvert_scaling2.png"),
...
ggsave(here("figures_rev2", "rda_calvert_scaling1.png.png"),
       width = 6.2, height = 5, dpi = 300)
```
