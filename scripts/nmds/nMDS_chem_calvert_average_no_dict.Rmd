...
ggsave(here("figures_rev2", "hc_average_chemtax_pelago.png"), p_dend,
...
ggsave(here("figures_rev2", "nmds_dendro_chem_average_pelago.png"), fig,
...
ggsave(here("figures_rev2", "nmds_chem_cluster_average_pelago.png"),
...
ggsave(here("figures_rev2", "bar_chemtax_cluster_average_4_vert_pelag.png"), 
...
chem_clust_h <- c_long_clust %>%   
  ggplot(aes(x = sample_name, y = TChla_mean, fill = fct_rev(phyto_group))) +
  geom_bar(stat = "identity", color = "black", size = 0.75) +
  # geom_rect(aes(xmin = 0, xmax = 12.3, ymin = 0.5, ymax = 10.5), fill = NA, 
  #           color = "black", size = 1) +
  # geom_rect(aes(xmin = 0, xmax = 12.3, ymin = 10.5, ymax = 29.5), fill = NA, 
...
ggsave(here("figures_rev2", "bar_chemtax_cluster_average_4_horiz_pelag.png"), 
...
ggsave(here("figures_rev2", "nmds_cluster_pelag.png"), nmds_chem_panel, 
