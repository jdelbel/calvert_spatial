...
fviz_dend(clust_ward_abund, cex = 0.5, k = 4, color_labels_by_k = TRUE)
```
...
ggsave(here("figures_nmds", "test-2023-02-15_2.png"),
...
ggsave(here("figures_nmds", "nmds_2023-02-15_2.png"), fig,
...
ggsave(here("figures_nmds", "nmds_2023-02-15_rel_2.png"), fig,
