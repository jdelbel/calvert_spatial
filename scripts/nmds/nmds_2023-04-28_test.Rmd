...
copdata <- micro_piv[, 8:ncol(micro_piv)]

#Transforming the abundance data
# t_abund <- species
dom <- decostand(copdata, "total")
...
fviz_dend(clust_ward_abund, cex = 0.5, k = 10, color_labels_by_k = TRUE)
```
...
ggsave(here("figures_nmds_new", "dendro_no_cryp_2023-04-28.png"),
...
ggsave(here("figures_nmds_new", "test.png"), fig,
