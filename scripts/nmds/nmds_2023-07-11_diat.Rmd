...
# t_abund <- decostand(species, "hellinger")
...
ggplot() +
 ...
 geom_hline(yintercept = 0.68, size = 1) +
...
```{r}
# write_csv(clust, here("outputs", "bio_clust_full_diat.csv"))
...
write_csv(export_cluster, here("outputs", "final_cluster_2023-07-31_diat.csv"))
```
...
micro_all$sample_name <- factor(micro_all$sample_name, levels = unique(hc_order))
```
