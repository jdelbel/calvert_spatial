...
nmds <-  metaMDS(transform, distance = "bray", autotransform = T,
                         k = 2, trymax = 100) 
...
nmds_diat <-  metaMDS(transform_diat, distance = "bray", autotransform = T,
                         k = 2, trymax = 100) 
...
nmds_dino <-  metaMDS(transform_dino, distance = "bray", autotransform = T,
                         k = 2, trymax = 100) 
...
ggsave(here("figures_nmds", "nmds_relative_all_data_test.png"), fig,
