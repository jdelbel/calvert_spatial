...
ggsave(here("figures_rev2", "hc_average_clusters_diatoms.png"), p_dend,
...
ggsave(here("figures_rev2", "nmds_CALVERT_year_diatoms.png"), fig,
...
ggsave(here("figures_rev2", "nmds_dendro_diatoms.png"), fig,
       width = 16, height = 12, dpi = 300)
...
ggsave(here("figures_rev2", "heat_indicator_2_diatom.png"),
...
ggsave(here("figures_rev2", "heat_indicator_5_clusters_abbr_diatom.png"),
       width = 13, height = 18, dpi = 300)
```
```{r}
...
ggsave(here("figures_rev2", "heat_indicator_5_clusters_abbr_2_diatom.png"),
       width = 13, height = 18, dpi = 300)
```
...
ggsave(here("figures_rev2", "heat_indicator_date_abbr_diatom.png"),
       width = 13, height = 18, dpi = 300)
...
ggsave(here("figures_rev2", "heat_indicator_site_abbr_diatom.png"),
       width = 13, height = 18, dpi = 300)
