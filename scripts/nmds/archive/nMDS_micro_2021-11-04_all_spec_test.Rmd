...
ggsave(here("figures_rev2", "test_full.png"), fig2,
       width = 16, height = 14, dpi = 300)
...
#Trying with indicator species from physical clustering
#Setting the order to the same as the clustering using the specified list
micro_heat$sample_name <- factor(micro_heat$sample_name, levels = unique(hc_order))
...
h1_2 <- micro_heat %>%   
   filter(scientificName == "Cerataulina bicornis" |
            scientificName == "Chaetoceros debilis" |
            ...
            scientificName == "Skeletonema marinoi" |
            scientificName == "Thalassiosira rotula" |
            scientificName == "Dictyocha fibula" |
            scientificName == "Ceratium lineatum" |
  ...
  #                      mid = "blue",
  #                      high = "#FF0000") +
  scale_y_discrete(labels = c("Cerataulina bicornis" = "C.b",
                              ...
                              "Pseudo-nitzschia seriata" = "Pn.s",
                              "Rhizosolenia setigera" = "R.s.",
                              "Skeletonema marinoi" = "S.m.",
                              "Thalassiosira rotula" = "T.r.",
                              "Dictyocha fibula" = "D.f.",
                              "Ceratium lineatum" = "C.l.",
...
```{r}
#Add indicator species from the physical clusters didn't help. 
fig <- p_dend2 / h1_2 + plot_layout(heights = c(1, 3))

fig2 <- fig_nmds_horiz / fig

ggsave(here("figures_rev2", "nmds_dendro_heat_2test.png"), fig2,
