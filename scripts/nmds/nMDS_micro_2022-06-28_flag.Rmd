...
```{r}
micro <- micro %>%
  filter(!class == "Dinophyceae" & !class == "Bacillariophyceae")
...
inv_site <- multipatt(transform, year, func = "r.g",
...
ggsave(here("figures_good", "hc_average_relative_2022-06-29_sp10.png"), p_dend,
