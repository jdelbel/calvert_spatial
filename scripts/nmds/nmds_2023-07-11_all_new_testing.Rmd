...
micro %>% 
  filter(scientificName == "Ditylum brightwellii") %>% 
...
fviz_dend(clust_ward_abund, cex = 0.5, h = 0.64, color_labels_by_k = TRUE)
...
dendro <- ggplot() +
 ...
 geom_hline(yintercept = 0.62, size = 1) +
...
ggsave(here("figures_nmds_new", "2023-10-04_complete_sqrt_60.png"),
...
ggplot(data = data.scores_abund, aes(x = NMDS1, y = NMDS2)) + 
  ...
  # geom_mark_hull(aes(color = as.factor(clust_abund)),
...
ggsave(here("figures_nmds_new", "dendro_box_2023-10-04_60.png"), fig,
...
ggsave(here("figures_nmds_new", "box_2023-10-04_60.png"), fig,
       width = 16, height = 16, dpi = 300)
```
