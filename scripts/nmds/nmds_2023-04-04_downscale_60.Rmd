...
ggsave(here("figures_nmds_new", "AAA_test_2023-04-04_60_ds_60.png"),
...
ggsave(here("figures_nmds_new", "AAA_nmds_2023-04-04_ds_60.png"),
...
ggsave(here("figures_nmds_new", "AAA_clust_panel2_ds_60.png"), cp,
...
ggsave(here("figures_nmds_new", "test_vert_ds_60.png"),
...
ggsave(here("figures_nmds_new", "AAA_test2_ds_60.png"), panel,
        width = 16, height = 8, dpi = 300)
```
...
ggsave(here("figures_nmds_new", "test_ds_60.png"), fig,
