...
fviz_dend(clust_ward_abund, cex = 0.5, h = 0.38, color_labels_by_k = TRUE)
```
...
ggplot() +
 ...
 scale_y_reverse(limits = c(0.6, -0.5)) +
 coord_flip() +
 theme_bw() +
...
ggsave(here("figures_nmds", "test-2023-03-21.png"),
...
ggsave(here("figures_nmds", "AAA.png"),
       width = 6, height = 12, dpi = 300)
```
...
ggsave(here("figures_nmds", "nmds_2023-03-21_GAH.png"), fig,
...
ggsave(here("figures_nmds", "A2023-03-31.png"), fig,
