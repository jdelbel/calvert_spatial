...
ggsave(here("figures_good", "test_panel3.png"), fig,
...
inv_site = multipatt(transform_diat, loc, func = "r.g",
...
ggsave(here("figures_good", "heat_test_rel_2.png"),
...
```{r}
#For dendrogram creation and not sure if doing here.
...
```{r}
test <- simper(transform, micro_piv$location)
test
...
ggsave(here("figures_rev2", "hc_average_names_10perc_rel_2022-07-18.png"), p_dend,
...
ggsave(here("figures_good", "test_panel.png"), fig,
