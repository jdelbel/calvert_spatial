...
barcolor_season <- colormap(colormap = colormaps$viridis, nshades = 4, format = "hex", alpha = 1, reverse = FALSE)
...
barcolor_full <- cbind(barcolor_yday, barcolor_season, barcolor_station)
colnames(barcolor_full) <- c("yday", "season", "station")
