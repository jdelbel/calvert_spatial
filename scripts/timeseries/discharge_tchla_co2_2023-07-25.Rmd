...
riv %>% 
  mutate(year = lubridate::year(date)) %>% 
  filter(Watershed_group == "Q_tot") %>% 
  ggplot(aes(x = as.factor(year), y = Q)) +
  geom_boxplot()
```
...
```{r}
# "dodgerblue3", "darkolivegreen", "red2", "goldenrod1"


cs_wan %>% 
  ggplot(aes(x = date, y = cs_raw/10^5, color = as.factor(year))) +
  geom_rect(aes(xmin = as.Date("2018-03-01"), xmax = as.Date("2018-06-01"), 
                ymin = 0, ymax = 1.5),
               fill = "darkolivegreen", color = "transparent", alpha = 0.002) +
  geom_rect(aes(xmin = as.Date("2018-06-01"), xmax = as.Date("2018-09-01"), 
                ymin = 0, ymax = 1.5),
               fill = "red2", color = "transparent", alpha = 0.005) +
  geom_rect(aes(xmin = as.Date("2018-09-01"), xmax = as.Date("2018-12-01"), 
                ymin = 0, ymax = 1.5),
               fill = "goldenrod1", color = "transparent", alpha = 0.002) +
  ...
  geom_rect(aes(xmin = as.Date("2019-06-01"), xmax = as.Date("2019-09-01"), 
                ymin = 0, ymax = 1.5),
               fill = "red2", color = "transparent", alpha = 0.002) +
...
ggsave(here("figures_river", "discharge_cs_season.png"),
       width = 16, height = 6, dpi = 300)
...
riv_mm %>% 
  ...
  scale_x_date(breaks = seq(as.Date("2018-01-01"), as.Date("2021-01-01"),
               ...
               date_labels = "%b%y") +
  scale_fill_brewer(palette = "Blues") +
  labs(y = bquote("Discharge" ~ "("*10^4~m^3*~s^-1*")"),
       fill = NULL) +
  theme_bw() +
...
ggsave(here("figures_river", "wind_season_mm.png"),
       width = 16, height = 6, dpi = 300)
...
cs_fig <- riv_test %>% 
  ...
  geom_point(aes(x = as.Date("2018-09-06"), y = 1.06778141/scale), pch = 21,
             fill = "white", stroke = 1.5, size = 2.5) +
  geom_point(aes(x = as.Date("2019-05-08"), y = -9.507108/scale), pch = 21,
             fill = "white", stroke = 1.5, size = 2.5) +
  geom_point(aes(x = as.Date("2019-09-11"), y = -5.008165/scale), pch = 21,
             fill = "white", stroke = 1.5, size = 2.5) +
  geom_point(aes(x = as.Date("2020-04-19"), y = -4.7487954/scale), pch = 21,
             fill = "white", stroke = 1.5, size = 2.5) +
  geom_point(aes(x = as.Date("2020-09-22"), y = 8.739361/scale), pch = 21,
             fill = "white", stroke = 1.5, size = 2.5) +
  scale_y_continuous(sec.axis = sec_axis(~.*scale,
  ...
  theme_bw() +
  theme(legend.position = c(0.08, 0.83),
        text = element_text(size = 30),
        axis.text = element_text(color = 'black'),
        axis.title.x = element_blank(),
        strip.background = element_blank(),
...
riv_test %>% 
  ...
  geom_point(aes(x = as.Date("2018-05-02"), y = 12.020980/scale), pch = 21,
             fill = "white", stroke = 1.5, size = 3) +
  geom_point(aes(x = as.Date("2018-09-06"), y = 37.39951/scale), pch = 21,
             fill = "white", stroke = 1.5, size = 3) +
  geom_point(aes(x = as.Date("2019-05-08"), y = 9.169442/scale), pch = 21,
             fill = "white", stroke = 1.5, size = 3) +
  geom_point(aes(x = as.Date("2019-09-11"), y = 32.05311/scale), pch = 21,
             fill = "white", stroke = 1.5, size = 3) +
  geom_point(aes(x = as.Date("2020-04-19"), y = 11.301365/scale), pch = 21,
             fill = "white", stroke = 1.5, size = 3) +
  geom_point(aes(x = as.Date("2020-09-22"), y = 47.55157/scale), pch = 21,
             fill = "white", stroke = 1.5, size = 3) +
  scale_y_continuous(sec.axis = sec_axis(~.*scale,
                                         name = bquote("Int. Dis."~"("*10^4~m^3*~s^-1*")"))) + 
  # geom_line(data = riv %>% filter(Watershed_group == "Wan"),
