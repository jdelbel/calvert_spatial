...
#Bringing down to Louis' group level
micro <- micro %>% 
...
transform <- micro_piv[, 6:17] 

#Trying relative abundance - this gives an interesting result. Turn off don't want relative abundance.
# transform <- transform %>% 
...
#Hellinger doesnt seem to work with NMDS - more for RDA
# transform <- transform %>%
...
```{r}
png(here("figures", "Calvert_qu39_monthly_nmds_group_abund_notrans.png"), width = 800, height = 500)
...
legend("topleft", "stress = 0.17", bty = "n", cex = 1.5)
