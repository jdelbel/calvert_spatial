...
ggsave(here("figures_rev2", "hc_average_rel.png"), p_dend,
...
p1 <- ggplot(data = data.scores.rel, aes(x = NMDS1, y = NMDS2)) + 
  geom_point(data = data.scores.rel, aes(fill = as.factor(month_surv), shape = site),
             size = 6) + 
  scale_fill_brewer(palette = "RdYlBu") +
  # scale_fill_manual(values = c("blue", "springgreen4", "black", "magenta")) + 
...
ggsave(here("figures_rev2", "nmds_dendro_rel.png"), fig,
...
inv_site = multipatt(transform_rel, site_id, func = "r.g",
