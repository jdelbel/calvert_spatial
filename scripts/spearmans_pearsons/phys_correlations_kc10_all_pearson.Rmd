...
ggsave(here("figures_good", "KC10_Wannock_dr_TS.png"), fig,
...
riv_w_j %>% 
  ggplot(aes(x = yday)) +
  geom_area(aes(y = sio2), size = 1, color = "purple", fill = "purple", alpha = 0.5) +
  geom_point(aes(y = abund*coeff_dr), size = 4, pch = 21, fill = "darkgreen",
             color = "black", stroke = 2) +
  scale_y_continuous(name = "\u394\u3C1",
                     sec.axis = sec_axis(~./coeff_dr,
                                         name = "Diatom Abundance")) +
  facet_grid(. ~ year) +
  theme_bw() +
