...
ggsave(here("figures_good", "correlations_KC10_Full_year_Spearman.png"),
...
ggsave(here("figures_good", "Channel_Wannock_Diatom_Abund_Full_year.png"), 
...
riv_w_j %>% 
  ...
  geom_line(aes(y = Wan_b1), size = 2, color = "blue") +
  geom_line(aes(y = Bel_b1), size = 2, color = "red") +
  geom_point(aes(y = vals*coeff_s), size = 4, pch = 21, fill = "darkgreen",
             color = "black", stroke = 2) +
  scale_y_continuous(name = "Wannock",
                     sec.axis = sec_axis(~./coeff_s, name="Diatom Abundance")) +
  facet_grid(. ~ year) +
  theme_bw() +
  theme(text = element_text(size = 25),
        axis.text.x = element_text(color = 'black'))

ggsave(here("figures_good", "Channel_Salinity_Diatom_Abund_Full_year.png"), 
       width = 16, height = 8, dpi = 300)
...
riv_w_j %>% 
  ggplot(aes(x = yday)) +
  geom_line(aes(y = lk_wd), size = 2, color = "blue") +
  geom_point(aes(y = abund*coeff), size = 4, pch = 21, fill = "darkgreen",
             color = "black", stroke = 2) +
  scale_y_continuous(name = "Wannock",
                     sec.axis = sec_axis(~./coeff, name="Diatom Abundance")) +
...
ggsave(here("figures_good", "Channel_WIND_Diatom_Abund_Full_year.png"),
       width = 16, height = 8, dpi = 300)
...
```{r}
riv_w_j %>% 
  ggplot(aes(x = Wan_b1, y = abund)) +
  geom_point(size = 4, pch = 21, fill = "darkgreen",
             color = "black", stroke = 2) 
```
