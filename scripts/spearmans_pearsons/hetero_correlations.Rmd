...
chl <- read_csv(here("files", "chemtax_2023-04-14.csv"))
...
cor_het2 <- micro %>%
  ...
  select(date, site_id, name = scientificName, het_count = species_sum)

cor_het4 <- rbind(cor_het, cor_het2)
