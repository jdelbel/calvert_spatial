...
ggsave(here("figures_good", "QCS01_Wannock_sal_DRho.png"), fig,
...
ggsave(here("figures_good", "QCS01_wind_par_TS.png"), fig_pw,
        width = 16, height = 12, dpi = 300)
```
...
fp1 <- riv_w_j %>%
  filter(!is.na(abund)) %>% 
  ggplot(aes(x = yday)) +
  geom_area(aes(y = par_b1), size = 1, color = "orange", fill = "orange", alpha = 0.5) +
  geom_point(aes(y = abund/coeff_p), size = 4, pch = 21, fill = "darkgreen",
             color = "black", stroke = 2) +
  geom_point(aes(y = tchla/coeff_p), size = 1.5, pch = 8, color = "red", stroke = 1) +
  scale_y_continuous(name = "Solar",
...
fw1 <- riv_w_j %>%
  filter(!is.na(abund)) %>% 
  ggplot(aes(x = yday)) +
  geom_area(aes(y = lk_w), size = 1, color = "blue", fill = "blue", alpha = 0.5) +
  geom_point(aes(y = abund*coeff_ws), size = 4, pch = 21, fill = "darkgreen",
             color = "black", stroke = 2) +
  geom_point(aes(y = tchla*coeff_ws), size = 1.5, pch = 8, color = "red", stroke = 1) +
  scale_y_continuous(name = "Wind^3",
...
ggsave(here("figures_good", "QCS01_wind_par_TS_ds.png"), fig_pw,
        width = 16, height = 12, dpi = 300)
```
