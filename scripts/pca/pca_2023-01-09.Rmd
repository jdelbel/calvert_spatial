...
#I think both of these dates have samples directly after that do have ancillary data, so might be worth just removing from analysis. What did I do in the monthly phytoplankton plot?
#2020-06-04-Channel.
...
inv_clust = multipatt(transform_diat, clust, func = "r.g",
