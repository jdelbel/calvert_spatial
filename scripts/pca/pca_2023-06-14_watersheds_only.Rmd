...
data_join %>% 
  # filter(site_id == "KC10") %>% 
  ggplot(aes(x = delta_rho_dm, y = wan_b1, )) +
...
data_pca <- data_join %>%
  select(date, month, year, sm_b1, gm_b1, ra_b1, wan_b1, wind_b1, 
         wind_dir_b1, par_b1, up_b1)
```
...
ggsave(here("figures_pca", "PCA-2023-08_03.png"), fig,
...
ggsave(here("figures_pca", "PCA-2023-08_03_single_no_turb.png"),
