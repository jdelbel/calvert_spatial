...
data_pca <- data %>%
  ...
  select(date, month, site_id, temp = temp_dm, sal = sal_dm, 
         ...
         secchi = secchi_depth, fwc = fwc_dm)
...
ggsave(here("figures_pca", "ward_eucl_2023-03-27_fwc_4.png"),
...
ggsave(here("figures_pca", "PCA_panel_2023-03-27_fwc_4.png"), fig,
...
data_clust_long <- data_clust %>% 
  pivot_longer(c(temp:fwc), names_to = "parameters", values_to = "values")
```
...
ggsave(here("figures_pca", "pca_box_fwc_4.png"), fig_panel,
