...
```{r}
write_csv(data_export, here("outputs", "ctd_wind_riv.csv"))
```
...
ggsave(here("figures_pca", "ward_eucl_2023-04-11_wind_par.png"),
...
ggsave(here("figures_pca", "PCA_panel_2023-04-11_wind_par.png"), fig,
...
ggsave(here("figures_pca", "pca_box_no_fwc.png"), fig_panel,
