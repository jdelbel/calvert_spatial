...
data_pca <- data_join %>%
  select(date, month, year, site_id, location, temp = temp_dm, 
         ...
         sio2_dm, secchi = secchi_depth, tchla)
```
...
fviz_dend(cluster.average, cex = 0.5, k = 4, color_labels_by_k = TRUE)
```
...
ggsave(here("figures_pca", "PCA-2023-07-19_all_data_div_upwell_no_enviro.png"), fig,
...
write_csv(export_cluster, here("outputs", "pca_cluster_2023-07-19_no-enviro.csv"))
```
