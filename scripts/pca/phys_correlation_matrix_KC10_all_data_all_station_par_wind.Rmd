...
data_short <- read_csv(here("outputs", "ctd_all_2022-11-25.csv"))

micro_short <- read_csv(here("outputs", "micro_all_2022-11-25.csv")) 
...
ggsave(here("figures_good", "corr_all_station_all_data_p05_par_wind.png"), fig,
