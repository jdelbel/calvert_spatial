...
ggsave(here("figures_pca", "pca_2023-02-28_wannock.png"),
...
ggsave(here("figures_pca", "pca_year_2023-02_28_wannock.png"), fig,
...
ggplot() +
 ...
 scale_y_reverse(limits = c(1000, -600)) +
 coord_flip() +
 theme_bw() +
...
ggsave(here("figures_pca", "ward_eucl_2023-02-28_Wannock.png"),
...
ggsave(here("figures_pca", "euclid_ward_2023-02-28.png"), fig,
...
no_clust_ctd <- data %>% 
  ...
  select(date, site_id, temp_dm, sal_dm, no2_dm, delta_rho_dm, secchi_depth, Wan_b1)
