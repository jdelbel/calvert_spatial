...
data <- read_csv(here("outputs", "ctd_merge_2022-11-16_upper5_avg.csv"))
...
data_pca <- data %>% 
  select(date, month, month_surv, site_id, temp, sal, 
         drho = delta_rho, no2_no3_um, sio2, po4,
...
ggsave(here("figures_good", "corr_test_2_P01_wind_upper5.png"), fig,
