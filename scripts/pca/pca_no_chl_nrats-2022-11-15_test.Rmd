...
data <- read_csv(here("outputs", "ctd_merge_2022-11-16_upper5_avg2.csv"))
...
riv3 <- riv2 %>% 
  select(date, dis_b1, dis_b25, dis_b40)
```
...
data_pca <- data %>% 
  select(date, month, month_surv, site_id, temp, sal, 
         drho = delta_rho, no2 = no2_no3_um, sio2, po4,
         secchi = secchi_depth, dis_b1, dis_b25, dis_b40, tchla)
...
ggsave(here("figures_good", "pca_2020-11-15_RIVER_upper5.png"),
...
ggsave(here("figures_good", "pca_year_2022-10-31_no_no2.png"), fig,
...
ggsave(here("figures_good", "ward_eucl_2022-10-31_only_no2.png"),
...
ggsave(here("figures_good", "ward_cluster_only_no2.png"), fig,
