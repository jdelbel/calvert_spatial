...
env.signif <- subset(expl, select = c(temp, po4, secchi, sal))
...
ggsave(here("figures_new", "rda_new_no_chla_scaled_s2.png"),
...
ggsave(here("figures_new", "rda_new_no_chla_scaled_s1.png"),
       width = 6.2, height = 5, dpi = 300)
```
