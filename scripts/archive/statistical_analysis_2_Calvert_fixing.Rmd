...
# I don't think this is actually doing a monthly average... It's combining the scientificNames with duplicates for a single date.
#Turning off for now, as I'm not sure I want to do this...
# micro_2 <- micro_2 %>%
