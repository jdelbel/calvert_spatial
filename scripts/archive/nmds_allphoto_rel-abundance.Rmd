...
#Selecting autotrophic groups in Calvert data
calvert <- micro_1 %>%
  filter(trophicStatus == "auto")

#Making Calvert columns comparable to QU39
calvert <- calvert %>% 
...
#Transform relative abundance by sqaure root (Simo-matchim)
