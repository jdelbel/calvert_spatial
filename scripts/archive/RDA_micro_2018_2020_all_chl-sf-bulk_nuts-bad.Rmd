...
ctd_calcs <- read_csv(here("outputs", "ctd_merge_master_2021-10-18.csv")) 
...
#Seems to be some wield data mis-matches. Will need to cross check this for accuracy. Particularily days when chlorophyll exists, but no other measurements. Shouldn't happen.

# ISSUES

#Including some samples from April...
