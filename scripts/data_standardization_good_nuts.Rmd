...
#Need to revamp this as nMDS now includes some heterotrophs...
# micro_piv <- micro %>% 
...
write_csv(ctd_merge_ds, here("outputs", "ctd_merge_2022-02-01_het.csv"))

#Exporting as a csv to pull into other analysis.
write_csv(micro_ds, here("outputs", "micro_master_2022-02-01_het.csv"))

#Exporting non-downscaled kc10 and QU39 dataset.
write_csv(micro_kc10, here("outputs", "micro_kc10_2022-02-01_het.csv"))

#Exporting downscaled kc10 and QU39 dataset.
write_csv(micro_kc10_ds, here("outputs", "micro_kc10_ds_2022-02-01_het.csv"))

#Exporting as a csv to pull into other analysis.
write_csv(cil_ds, here("outputs", "ciliate_master_2022-02-01_het.csv"))

#Exporting as a csv to pull into other analysis.
write_csv(dino_het_ds, here("outputs", "dino-het_master_2022-02-01_het.csv"))

#Exporting as a csv to pull into other analysis.
write_csv(fec_ds, here("outputs", "fecal_master_2022-02-01_het.csv"))

#Exporting as a csv to pull into other analysis.
write_csv(chem_ds, here("outputs", "chemtax_master_2022-02-01_het.csv"))
```
