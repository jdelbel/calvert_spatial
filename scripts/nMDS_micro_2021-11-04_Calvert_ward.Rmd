...
cluster.average <- hclust(sqrt(dis), method = "ward.D2")
...
p_dend <- ggplot() +
 ...
 scale_y_reverse(limits = c(1.3, -1)) +
 coord_flip() + 
 theme_bw() + 
...
ggsave(here("figures_rev2", "hc_average_clusters_5_ward.png"), p_dend,
...
ggsave(here("figures_rev2", "nmds_CALVERT_year_ward.png"), fig,
...
ggsave(here("figures_rev2", "nmds_dendro_5_clust_ward.png"), fig,
       width = 16, height = 12, dpi = 300)
...
ggsave(here("figures_rev2", "heat_indicator_5_clusters_abbr_good.png"),
       width = 13, height = 18, dpi = 300)
```
