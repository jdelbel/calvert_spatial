...
```{r}
#Running PCA using vegan - when RDA is run without reponse variables, then it is a PCA
pca <- rda(expl)
...
ggsave(here("figures_rev2", "PCA_test2.png"),
...
```{r}
#Trying hierarchical clustering on this data. Is this necessary?

#I would just move on to The chemtax data and making the plot for this.
```
