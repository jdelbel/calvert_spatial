...
plot(rda.signif, scaling = 2, type = "none", xlab = c("RDA1 (6%)"),
               ylab = c("RDA2 (3%)"), xlim = c(-0.5, 0.5), ylim = c(-1.1, 1.1))
...
text(rda.signif, scaling = 2, display = "bp", col = "blue",cex = 1.5, font = 2)
...
arrows(0,0, scores(rda.signif, display = "species", choices = c(1),
                   scaling = 2) * 2, scores(rda.signif, display="species",
                                            choices = c(2), scaling = 2) * 2,
