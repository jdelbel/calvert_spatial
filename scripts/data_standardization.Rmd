...
##Removeing data outside of timeframe under investigation
micro <- micro %>% 
  filter(date > "2018-01-01" & date < "2021-01-01")
...
```{r}
#Working with the chlorophyll data to make it mergable with other data.
...
write_csv(ctd_merge_ds, here("outputs", "ctd_merge_master_2021-10-06.csv"))

#Exporting as a csv to pull into other analysis.
write_csv(micro_ds, here("outputs", "micro_master_2021-10-06.csv"))
