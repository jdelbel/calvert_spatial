...
test1 <- micro %>% 
  filter(site_id == "KC10" & date > "2018-01-01" & date < "2021-01-01") %>% 
  distinct(date)
...
#2019-04-02 is wuite a ways off from 2019-04-18 at KC10. For some reason not much data at QU39 in this year/month.
...
write_csv(ctd_merge_ds, here("outputs", "ctd_merge_2021-12-01_chem.csv"))

#Exporting as a csv to pull into other analysis.
write_csv(micro_ds, here("outputs", "micro_master_2021-10-18.csv"))

#Exporting non-downscaled kc10 and QU39 dataset.
write_csv(micro_kc10, here("outputs", "micro_kc10_2021-12-01.csv"))

#Exporting downscaled kc10 and QU39 dataset.
write_csv(micro_kc10_ds, here("outputs", "micro_kc10_ds_2021-12-01.csv"))
