...
resp <- micro_join[, 16:ncol(micro_join)]
...
sp_bf <- subset(sp_loc, rownames(sp_loc) %in% sel2)
```
...
ggsave(here("figures_rda", "rda_2023-04-05.png"), micro_comb,
