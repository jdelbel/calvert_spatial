...
micro_het <- micro %>% 
  filter(scientificName == "Protoperidinium" | scientificName == "Gymnodinium" |
           scientificName == "Gyrodinium" | scientificName == "Oligotrichea") 

micro_het_wide <- micro_het %>% 
...
env.signif <- subset(expl, select = c(Protoperidinium, Oligotrichea))
