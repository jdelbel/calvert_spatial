...
micro_piv <- micro %>%
  ...
  select(date, month, site_id, group, group_sum)
...
sp_bf <-  as.data.frame(rda.sign.sum$species[,1:2])
...
ggsave(here("figures_rda", "rda_2023-07-18_all.png"), 
