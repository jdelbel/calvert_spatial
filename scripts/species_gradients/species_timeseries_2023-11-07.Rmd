...
#   annotate("text", x = as.Date("2018-02-18"), y = 29, label = "a) FJORD", size = 10) +
#   theme_bw() +
#   theme(text = element_text(size = 25),
#         axis.title.x = element_blank(),
#         axis.text.x = element_blank(),
...
#   # ylim(0, 32) +
#   labs(y = bquote("Phy. (mg" ~ m^-3*")")) +
#   annotate("text", x = as.Date("2018-02-25"), y = 11, label = "b) CHEMTAX",
#            size = 10) +
#   theme_bw() +
#   theme(text = element_text(size = 25),
#         axis.title.x = element_blank(),
...
#   scale_y_continuous(expand = c(0, 0), limits = c(0, 32)) +
#   labs(y = bquote("Abun. ("~10^5 ~ cells ~ L^-1*")")) +
#   annotate("text", x = as.Date("2018-02-20"), y = 29, label = "c) CHANNEL",
#            size = 10) +
#   theme_bw() +
#   theme(text = element_text(size = 25),
#         axis.title.x = element_blank(),
...
#   # ylim(0, 32) +
#   labs(y = bquote("Phy. (mg" ~ m^-3*")")) +
#   annotate("text", x = as.Date("2018-02-25"), y = 11, label = "d) CHEMTAX",
#            size = 10) +
#   theme_bw() +
#   theme(text = element_text(size = 25),
#         axis.title.x = element_blank(),
...
#   scale_y_continuous(expand = c(0, 0), limits = c(0, 32)) +
#   labs(y = bquote("Abun. ("~10^5 ~ cells ~ L^-1*")")) +
#   annotate("text", x = as.Date("2018-02-18"), y = 29, label = "e) SHELF", size = 10) +
#   theme_bw() +
#   theme(text = element_text(size = 25),
#         axis.title.x = element_blank(),
#         axis.text.x = element_blank(),
...
#   # ylim(0, 32) +
#   labs(y = bquote("Phy. (mg" ~ m^-3*")")) +
#   annotate("text", x = as.Date("2018-02-25"), y = 11, label = "f) CHEMTAX",
#            size = 10) +
#   theme_bw() +
#   theme(text = element_text(size = 25),
#         axis.title.x = element_blank(),
...
fig_month_c <- fig_month_m / (cf + cc + cs)
```
...
sf <- sf_less %>%
  ...
  annotate(geom = "rect",
           ...
           ymin = 0, ymax = Inf,
           fill = "goldenrod1", color = "transparent", alpha = 0.2) +
  geom_bar(aes(x = month_date, y = chla,
           fill = fct_rev(filter_type)), stat = "identity", position = "stack",
           color = "black") +
  # scale_fill_manual(values = palette) +
  ggsci::scale_fill_d3() +
  scale_x_date(breaks = seq(as.Date("2018-01-01"), as.Date("2021-01-01"),
...
fig_tot <- (mf + mc + ms) / (cf + cc + cs) / (sf + sc + ss)
```


```{r}
ggsave(here("figures_species_timeseries", "test_single_6.png"), fig_tot,
