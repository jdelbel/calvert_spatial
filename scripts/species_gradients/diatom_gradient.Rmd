...
ggsave(here("figures_good", "timeseries-diatoms_gt25k.png"),
       width = 16, height = 8, dpi = 300)
```

```{r}
#This seems to work pretty well - Can decide between percentage or abundance threshold. Would be good to add specifications for skeletonema size (This is going to be super tricky to add.)
```
